...
import com.letsdowebsite.ambassadorsheilarenee.Faith;
import com.letsdowebsite.ambassadorsheilarenee.Prayer;
        ...
        public MyViewHolder(View itemView) {
         ...
         //   this.textViewName = (TextView) itemView.findViewById(R.id.txtView);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                {
                  if (getPosition()==0) {
                   context.startActivity( new Intent( context, Faith.class ) );
                  } if (getPosition()==1) {
