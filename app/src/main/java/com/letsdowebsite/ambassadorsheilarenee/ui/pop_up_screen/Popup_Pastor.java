...
public class Popup_Pastor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popup__pastor);
        ...
        ib_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Popup_Pastor.this, ServicesDetails2.class);
        ...
        closePopupBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Popup_Pastor.this, BookNow2.class);
                startActivity(intent);
            }
        });
