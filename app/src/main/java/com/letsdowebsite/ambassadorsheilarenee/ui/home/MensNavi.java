...
import com.letsdowebsite.ambassadorsheilarenee.MensMotivational;
...
public class MensNavi extends RecyclerView.Adapter<MensNavi.MyViewHolder> {
        ...
        public MyViewHolder(View itemView) {
         ...
         //   this.textViewName = (TextView) itemView.findViewById(R.id.txtView);
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                {
                  if (getPosition()==0) {
                   context.startActivity( new Intent( context, MensMotivational.class ) );
                  } if (getPosition()==1) {
    ...
    public MensNavi(ArrayList<Arraylist> data) {
        this.dataSet = data;
    }
