...
public class Popup_TeachSeminar extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popup__teachseminar);
        ...
        ib_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Popup_TeachSeminar.this, ServicesDetails2.class);
        ...
        closePopupBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Popup_TeachSeminar.this, BookNow2.class);
                startActivity(intent);
            }
        });
