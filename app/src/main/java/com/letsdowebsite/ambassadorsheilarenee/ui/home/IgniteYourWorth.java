...
public class IgniteYourWorth extends RecyclerView.Adapter<IgniteYourWorth.MyViewHolder> {
    ...
    public IgniteYourWorth(ArrayList<Arraylist> data) {
        this.dataSet = data;
    }

    @Override
    public IgniteYourWorth.MyViewHolder onCreateViewHolder(ViewGroup parent,
                                                           int viewType) {
        ...
        IgniteYourWorth.MyViewHolder myViewHolder = new IgniteYourWorth.MyViewHolder(view);
        return myViewHolder;
    }

    @Override
    public void onBindViewHolder(final IgniteYourWorth.MyViewHolder holder, final int listPosition) {
