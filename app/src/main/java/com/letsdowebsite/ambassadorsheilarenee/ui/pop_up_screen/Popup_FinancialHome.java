...
public class Popup_FinancialHome extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popup__financials);
        ...
        ib_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Popup_FinancialHome.this, MainActivity.class);
        ...
        closePopupBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Popup_FinancialHome.this, BookNow3.class);
                startActivity(intent);
            }
        });
