...
public class Video3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        youtubeVideos.add( new YouTubeVideos( "<iframe width=\"100%\" height=\"100%\" src=\"https://www.youtube.com/embed/UcEbG6A_kfk\" frameborder=\"0\" allowfullscreen></iframe>" ) );
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent i = new Intent( Video3.this, MainActivity.class);
              startActivity(i);
