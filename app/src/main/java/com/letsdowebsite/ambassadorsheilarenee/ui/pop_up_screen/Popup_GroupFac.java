...
public class Popup_GroupFac extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_popup__groupfac);
        ...
        ib_close.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Popup_GroupFac.this, ServicesDetails2.class);
        ...
        closePopupBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(Popup_GroupFac.this, BookNow2.class);
                startActivity(intent);
            }
        });
