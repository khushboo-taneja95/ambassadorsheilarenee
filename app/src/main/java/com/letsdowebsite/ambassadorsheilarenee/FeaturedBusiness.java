...
public class FeaturedBusiness extends AppCompatActivity {
        ...
        protected void onCreate(Bundle savedInstanceState) {
                ...
                setContentView(R.layout.featuress);
                ...
                back.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                                ...
                                Intent intent = new Intent( FeaturedBusiness.this, MainActivity.class);
                ...
                appointment.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                                ...
                                Intent intent = new Intent(FeaturedBusiness.this, Appointment.class);
                                startActivity(intent);
                        }
                });
                ...
                contactus.setOnClickListener(new View.OnClickListener() {
                        ...
                        public void onClick(View v) {
                                ...
                                Intent intent = new Intent(FeaturedBusiness.this, Contact.class);
                                startActivity(intent);
                        }
                });
