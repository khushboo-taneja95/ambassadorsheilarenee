...
public class VisitWebsite extends AppCompatActivity {
    ...
    private String currentUrl="https://ambassadorsheilarenee.com/";
   ...
   //     mWebview.getSettings().setBuiltInZoomControls(true);
        ...
        mWebview.loadUrl( "https://ambassadorsheilarenee.com/" );
        ...
        mWebview.setWebViewClient( new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder( VisitWebsite.this);
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog( VisitWebsite.this );
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mWebview.canGoBack()) {
                    ...
                    Intent intent = new Intent( VisitWebsite.this, MainActivity.class);
                    startActivity(intent);
                }
            }
        });
