...
public class BookNow2 extends AppCompatActivity {
    ...
    public void WebAction() {
        ...
        mWebview.loadUrl( "https://ambassadorsheilarenee.com/events/mens-prayer-ministry/" );
        ...
        mWebview.setWebViewClient( new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(BookNow2.this);
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog( BookNow2.this );
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mWebview.canGoBack()) {
                    ...
                    Intent intent = new Intent(BookNow2.this, MainActivity.class);
                    startActivity(intent);
                }
            }
        });
