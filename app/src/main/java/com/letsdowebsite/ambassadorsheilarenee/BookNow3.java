...
public class BookNow3 extends AppCompatActivity {
    ...
    public void WebAction() {
        ...
        mWebview.loadUrl( "https://ambassadorsheilarenee.com/events/ministry-services/" );
        ...
        mWebview.setWebViewClient( new WebViewClient() {
            ...
            public void onReceivedSslError(WebView view, final SslErrorHandler handler, SslError error) {
                final AlertDialog.Builder builder = new AlertDialog.Builder(BookNow3.this);
            ...
            public void onLoadResource (WebView view, String url) {
                if (progressDialog == null) {
                    ...
                    progressDialog = new ProgressDialog( BookNow3.this );
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mWebview.canGoBack()) {
                    ...
                    Intent intent = new Intent(BookNow3.this, MainActivity.class);
                    startActivity(intent);
                }
            }
        });
